...
/**
 * The two preferences behind AutoMix, kept apart from the markup and the store
 ...
 */
export const AoideAutomixSchema = z.boolean();
 ...
 */
export const DEFAULT_AOIDE_AUTOMIX = false;

/**
 * On. This is what makes AutoMix safe to leave on: a record sequenced to run
 * continuously still does. It is the mixer's off-switch for the albums that
 * need one, never a second mixer — with AutoMix off, an unlocked album run is
